...
export const SITEMAP: SiteMapModel[] = [
...
export const FLAT_CATEGORIES: FlatCategoriesModel[] = [
...
export const COTTAGES_CATEGORIES: CottagesCategoriesModel[] = [
...
export const POPULAR: PopularCategoriesModel[] = [
