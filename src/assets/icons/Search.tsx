...
interface SearchIconProps extends DetailedHTMLProps<SVGAttributes<SVGAElement>, SVGAElement> {
  height?: string;
  width?: string;
}

const SearchIcon = ({ height = "18", width = "18", className }: SearchIconProps): JSX.Element => {
  return (
    <svg
      width={width}
      height={height}
