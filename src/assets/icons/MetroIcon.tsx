...
interface MetroIconProps extends DetailedHTMLProps<SVGAttributes<SVGAElement>, SVGAElement> {
  height?: string;
  width?: string;
}

const MetroIcon = ({ height = "20", width = "13", className }: MetroIconProps): JSX.Element => {
  return (
    <svg
      width={width}
      height={height}
