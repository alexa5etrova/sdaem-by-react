...
interface CrossIconProps extends DetailedHTMLProps<SVGAttributes<SVGAElement>, SVGAElement> {
  height?: string;
  width?: string;
}

const CrossIcon = ({ height = "10", width = "10", className }: CrossIconProps): JSX.Element => {
  return (
    <svg
      className={className}
      width={width}
