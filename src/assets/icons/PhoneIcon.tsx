...
interface PhoneIconProps extends DetailedHTMLProps<SVGAttributes<SVGAElement>, SVGAElement> {
  height?: string;
  width?: string;
}

const PhoneIcon = ({ height = "9", width = "15", className }: PhoneIconProps): JSX.Element => {
  return (
    <svg
      width={width}
      height={height}
